  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
      ...
      <div className="p-4">
        ...
        {product.stock <= 2 && (
          <p className="text-orange-500 flex items-center text-sm mb-3">
      ...
      <div className="bg-gray-100 p-3 mt-2">
        ...
        <button 
          ...
          className="w-full bg-blue-500 text-white py-2 rounded-md flex items-center justify-center hover:bg-blue-600 transition-colors disabled:bg-gray-400"
        >
